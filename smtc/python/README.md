...
### Option 1: System-wide installation (Python 3.10+)
On Raspberry Pi OS with Python 3.10 or later, use:
```bash
sudo pip install --break-system-packages sm-tc
```

### Option 2: User installation (Recommended for single user)
```bash
pip install --user sm-tc
```
